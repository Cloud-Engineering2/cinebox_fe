...
const UserList = () => {
    ...
    const deleteUser = useCallback((userId) => {
        doDeleteMovieRequest(process.env.REACT_APP_USER_API + `/${userId}/withdraw`, {
            method: 'POST'
        })
                ...
                return <>
                    <Box
                        ...
                        <Box className='controlBox'>
                            ...
                            {(user.role != 'USER' && user.userId != context.userId) && <button id="delete" type="button" className="button-sm" onClick={() => deleteUser(user.userId)}>삭제</button>}
                        </Box>
                    </Box>
                </>
